...
public class StudentInfo {
    ...
    public static void display() {
        ...
        System.out.println("************************************************************");
        System.out.println("*            Student name: Kelly Guo                       *");
        System.out.println("*            Student number: 300140431                     *");
        System.out.println("*            Student name: Hongru Wang                     *");
        System.out.println("*            Student number: 300140660                     *");
        System.out.println("************************************************************");
        System.out.println();
